...
public class autoMobile {
    ...
    public void display()
    {
       ...
       System.out.println("Cars Name");
   	 ...
   	 {
   		 String play2 = companyLocation[i];
   	 ...
   	 {
			long play5 = totalVehicleDelivered[i];
   	 ...
   	 {
			String play6 = companyOwnersName[i];
