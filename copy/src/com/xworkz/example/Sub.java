...
public class Sub {
	 public String    name;
	    ...
	    public Sub(String name,String type,String invented,int  types,boolean freeToLearn,String[] typesOfSubjects,String[] typesOfExams,String[] typesOfMarks,double[] fee,long[] totalStudentsInCountry,String[] countryNames)
	    {
	   	 this.name = name;
	   	 this.type = type;
