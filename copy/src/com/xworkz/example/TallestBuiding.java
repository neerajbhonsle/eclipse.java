...
public class TallestBuiding {
    ...
    public TallestBuiding(String name,String type,String Architectur,int  noOfBuildings,boolean isTheySafe,String[] typesOfBuildings,String[] typesOfdesigns,String[] typesOfBuilders,double[] area,long[] priceOfTheBuilding,String[] countryNames)
    {
   	 this.name = name;
   	 this.type = type;
