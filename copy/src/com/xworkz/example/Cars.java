...
public class Cars {
    ...
    public Cars(String name,char type,String cars,int  noOfCars,boolean topEnd,String[] carsName,String[] companyLocation,String[] carsLogo,double[] price,long[] totalVehicleDelivered,String[] companyOwnersName)
