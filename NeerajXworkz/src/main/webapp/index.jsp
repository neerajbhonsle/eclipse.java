...
<nav class="navbar">
			...
			<div class="container-fluid">
				...
				<a href="drink">click here to register</a>
				<a href="search.jsp">search</a>
				<a href="brandSearch.jsp">searchBybrand</a>
				<a href="getAll">findAllbrand</a>
				<a href="brandAndCost.jsp">findByBrandAndCost</a>
					<a href="uploadImage.jsp">uploadImage</a>
					<a href="download.jsp">displayImage</a>
			</div>
